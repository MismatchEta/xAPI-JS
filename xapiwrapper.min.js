...
var CryptoJS = (CryptoJS = CryptoJS || function(l) {
    ...
    e.BufferedBlockAlgorithm = i.extend({
        ...
        _process: function(t) {
            var e = this._data
              ...
              , r = this.blockSize
              , o = n / (4 * r)
              , s = (o = t ? l.ceil(o) : l.max((0 | o) - this._minBufferSize, 0)) * r
              , a = l.min(4 * s, n);
            if (s) {
                for (var c = 0; c < s; c += r)
      ...
      , f = d.SHA1 = p.extend({
        ...
        _doProcessBlock: function(t, e) {
            for (var i = this._hash.words, n = i[0], r = i[1], o = i[2], s = i[3], a = i[4], c = 0; c < 80; c++) {
                ...
                l += c < 20 ? 1518500249 + (r & o | ~r & s) : c < 40 ? 1859775393 + (r ^ o ^ s) : c < 60 ? (r & o | r & s | o & s) - 1894007588 : (r ^ o ^ s) - 899497514,
                a = s,
                s = o,
                o = r << 30 | r >>> 2,
                r = n,
    ...
    return t.SHA1 = p._createHelper(f),
    t.HmacSHA1 = p._createHmacHelper(f),
    t
}(Math)) || function(a) {
    function i() {}
    var t = {}
      ...
      , l = e.BufferedBlockAlgorithm = n.extend({
        ...
        _process: function(t) {
            var e = this._data
              ...
              , r = this.blockSize
              , o = n / (4 * r);
            if (t = (o = t ? a.ceil(o) : a.max((0 | o) - this._minBufferSize, 0)) * r,
            n = a.min(4 * t, n),
            t) {
                for (var s = 0; s < t; s += r)
...
function toSHA1(t) {
    return CryptoJS && CryptoJS.SHA1 ? CryptoJS.SHA1(t).toString() : Crypto.util.bytesToHex(Crypto.SHA1(t, {
        asBytes: !0
    }))
}
function toSHA256(t) {
...
function isDate(t) {
    if ("[object Date]" === Object.prototype.toString.call(t))
        ...
        e = new Date(t);
    return "[object Date]" === Object.prototype.toString.call(e) ? isNaN(e.valueOf()) ? (ADL.XAPIWrapper.log("Invalid date String passed"),
    null) : e : (ADL.XAPIWrapper.log("Invalid date object"),
    null)
}
!function(r) {
    function t(t) {
    ...
    for (var e = CryptoJS, i = (o = e.lib).WordArray, n = o.Hasher, o = e.algo, s = [], f = [], a = 2, c = 0; c < 64; ) {
        var p;
        t: {
            p = a;
    ...
    o = o.SHA256 = n.extend({
        ...
        _doProcessBlock: function(t, e) {
            for (var i = this._hash.words, n = i[0], r = i[1], o = i[2], s = i[3], a = i[4], c = i[5], p = i[6], l = i[7], u = 0; u < 64; u++) {
                if (u < 16)
                    g[u] = 0 | t[e + u];
                else {
                    var d = g[u - 15]
                ...
                d = l + ((a << 26 | a >>> 6) ^ (a << 21 | a >>> 11) ^ (a << 7 | a >>> 25)) + (a & c ^ ~a & p) + f[u] + g[u],
                h = ((n << 30 | n >>> 2) ^ (n << 19 | n >>> 13) ^ (n << 10 | n >>> 22)) + (n & r ^ n & o ^ r & o),
                l = p,
                p = c,
                c = a,
                a = s + d | 0,
    ...
    e.SHA256 = n._createHelper(o),
    e.HmacSHA256 = n._createHmacHelper(o)
}(Math),
function() {
    var t = CryptoJS
      , p = t.enc.Utf8;
    t.algo.HMAC = t.lib.Base.extend({
        init: function(t, e) {
            ...
            e.clamp();
            for (var r = this._oKey = e.clone(), o = this._iKey = e.clone(), s = r.words, a = o.words, c = 0; c < i; c++)
                s[c] ^= 1549556828,
                a[c] ^= 909522486;
        ...
        e.prototype.encode = function(t) {
            for (var e = new Uint8Array(3 * t.length), i = -1, n = t.length, r = 0; r < n; ) {
                var o = c(t, r)
                  , s = 0
                  , a = 0;
                for (o <= 127 ? a = s = 0 : o <= 2047 ? (s = 6,
                a = 192) : o <= 65535 ? (s = 12,
                a = 224) : o <= 2097151 && (s = 18,
                a = 240),
                e[i += 1] = a | o >> s,
                s -= 6; 0 <= s; )
                    e[i += 1] = 128 | o >> s & 63,
    ...
    if (void 0 === t.TextDecoder) {
        function a(t) {
            ...
            for (var e = [], i = "", n = 0, r = arguments.length; n !== r; ++n) {
                ...
                16383 <= (o <= 65535 ? e.push(o) : (o -= 65536,
                e.push(55296 + (o >> 10), o % 1024 + 56320))) && (i += String.fromCharCode.apply(null, e),
                e.length = 0)
            }
...
function(_) {
    ...
    function t(t, e) {
        ...
        this.lrs = function(t) {
            var e, i, n = ["endpoint", "auth", "actor", "registration", "activity_id", "grouping", "activity_platform"], r = new Object;
            if (void 0 !== (e = function() {
                var t, e, i, n, r;
                for (t = window.location.search.substr(1),
                e = t.split("&"),
                r = {},
                n = 0; n < e.length; n++)
                    2 === (i = e[n].split("=")).length && i[0] && (r[i[0]] = decodeURIComponent(i[1]));
                return r
        ...
        this.lrs.user && this.lrs.password && n(this.lrs, this.lrs.user, this.lrs.password),
        this.base = i(this.lrs.endpoint),
        this.withCredentials = !1,
        t && void 0 !== t.withCredentials && (this.withCredentials = t.withCredentials),
            ...
            if (200 == t.status)
                try {
                    ...
                    for (var n in e.version)
                        if (e.version.hasOwnProperty(n) && e.version[n] == _.XAPIWrapper.xapiVersion) {
                            i = !0;
                            break
                        }
                ...
                _.XAPIWrapper.log("The request to get information about the LRS failed: " + t)
        }, null, !1, null, this.withCredentials, !1),
        ...
        this.hash = function(t) {
            ...
            try {
                ...
                return _.XAPIWrapper.log("Error trying to hash -- " + t),
                null
            }
        }
        ,
        this.changeConfig = function(t) {
            try {
                ...
                t.user && t.password && this.updateAuth(this.lrs, t.user, t.password),
                this.base = i(this.lrs.endpoint),
    ...
    function a(e, i) {
        for (var n in i)
            if (0 != i.hasOwnProperty(n)) {
                u(n + " : " + i[n]);
                try {
                    i[n].constructor == Object ? e[n] = a(e[n], i[n]) : (null == e && (e = new Object),
                    e[n] = i[n])
                } catch (t) {
                    null == e && (e = new Object),
                    e[n] = i[n]
    ...
    t.prototype.prepareStatement = function(t) {
        void 0 === t.actor ? t.actor = JSON.parse(this.lrs.actor) : "string" == typeof t.actor && (t.actor = JSON.parse(t.actor)),
        (this.lrs.grouping || this.lrs.registration || this.lrs.activity_platform) && (t.context || (t.context = {})),
        this.lrs.grouping && (t.context.contextActivities || (t.context.contextActivities = {}),
        Array.isArray(t.context.contextActivities.grouping) ? t.context.contextActivities.grouping.splice(0, 0, {
            id: this.lrs.grouping
        }) : t.context.contextActivities.grouping = [{
            id: this.lrs.grouping
        }]),
        this.lrs.registration && (t.context.registration = this.lrs.registration),
        this.lrs.activity_platform && (t.context.platform = this.lrs.activity_platform)
    }
    ,
    ...
    t.prototype.sendStatement = function(t, e, i) {
        if (this.testConfig()) {
            ...
            t.id ? n = t.id : (n = _.ruuid(),
            t.id = n);
            var r = JSON.stringify(t)
              , o = null;
            i && 0 < i.length && (o = {},
            r = this.buildMultipartPost(t, i, o));
            var s = _.XHR_request(this.lrs, this.lrs.endpoint + "statements", "POST", r, this.lrs.auth, e, {
                id: n
            }, null, o, this.withCredentials, this.strictCallbacks);
            if (!e)
                return {
                    xhr: s,
                    id: n
    ...
    t.prototype.stringToArrayBuffer = function(t, e) {
        return e = e || _.XAPIWrapper.defaultEncoding,
    ...
    t.prototype.buildMultipartPost = function(t, e, i) {
        ...
        for (var n = 0; n < e.length; n++)
            ...
            "string" == typeof e[n].value && (e[n].value = this.stringToArrayBuffer(e[n].value)),
            e[n].type.length = e[n].value.byteLength,
            e[n].type.sha2 = toSHA256(e[n].value),
            t.attachments.push(e[n].type);
        var r = []
          , o = (Math.random() + " ").substring(2, 10) + (Math.random() + " ").substring(2, 10);
        ...
        for (var n in r.push(a),
        e)
            if (e.hasOwnProperty(n)) {
                var c = ["--" + o, "Content-Type: " + e[n].type.contentType, "Content-Transfer-Encoding: binary", "X-Experience-API-Hash: " + e[n].type.sha2].join(s) + s + s;
                r.push(c),
                r.push(e[n].value)
            }
        return r.push(s + "--" + o + "--" + s),
    ...
    t.prototype.sendStatements = function(t, e) {
        if (this.testConfig()) {
            for (var i in t)
                t.hasOwnProperty(i) && this.prepareStatement(t[i]);
                ...
                for (s in t)
                    if (t.hasOwnProperty(s))
                        if ("until" == s || "since" == s) {
                            ...
                            r.push(s + "=" + encodeURIComponent(t[s]));
    ...
    t.prototype.sendState = function(t, e, i, n, r, o, s, a) {
        if (this.testConfig()) {
            var c = this.lrs.endpoint + "activities/state?activityId=<activity ID>&agent=<agent>&stateId=<stateid>";
            c = (c = (c = c.replace("<activity ID>", encodeURIComponent(t))).replace("<agent>", encodeURIComponent(JSON.stringify(e)))).replace("<stateid>", encodeURIComponent(i)),
            n && (c += "&registration=" + encodeURIComponent(n));
            var p = null;
            o && s ? u("Can't have both If-Match and If-None-Match") : o ? p = {
                "If-Match": _.formatHash(o)
            } : s && (p = {
                "If-None-Match": _.formatHash(s)
            });
            var l = "PUT";
            if (!r)
                return this.log("No activity state was included."),
                !1;
            r instanceof Array ? (r = JSON.stringify(r),
            (p = p || {})["Content-Type"] = "application/json") : r instanceof Object ? (r = JSON.stringify(r),
            (p = p || {})["Content-Type"] = "application/json",
            l = "POST") : (p = p || {})["Content-Type"] = "application/octet-stream",
            _.XHR_request(this.lrs, c, l, r, this.lrs.auth, a, null, null, p, this.withCredentials, this.strictCallbacks)
        }
    }
    ,
    t.prototype.getState = function(t, e, i, n, r, o) {
        if (this.testConfig()) {
            ...
            s = (s = s.replace("<activity ID>", encodeURIComponent(t))).replace("<agent>", encodeURIComponent(JSON.stringify(e))),
            i && (s += "&stateId=" + encodeURIComponent(i)),
            n && (s += "&registration=" + encodeURIComponent(n)),
            r && null != (r = isDate(r)) && (s += "&since=" + encodeURIComponent(r.toISOString()));
    ...
    t.prototype.deleteState = function(t, e, i, n, r, o, s) {
        if (this.testConfig()) {
            ...
            a = (a = (a = a.replace("<activity ID>", encodeURIComponent(t))).replace("<agent>", encodeURIComponent(JSON.stringify(e)))).replace("<stateid>", encodeURIComponent(i)),
            n && (a += "&registration=" + encodeURIComponent(n));
            var c = null;
            r && o ? u("Can't have both If-Match and If-None-Match") : r ? c = {
                "If-Match": _.formatHash(r)
            } : o && (c = {
                "If-None-Match": _.formatHash(o)
            });
            var p = _.XHR_request(this.lrs, a, "DELETE", null, this.lrs.auth, s, null, !1, c, this.withCredentials, this.strictCallbacks);
            if (void 0 === p || 404 == p.status)
                return null;
            try {
    ...
    t.prototype.sendActivityProfile = function(t, e, i, n, r, o) {
        if (this.testConfig()) {
            ...
            var a = null;
            n && r ? u("Can't have both If-Match and If-None-Match") : n ? a = {
                "If-Match": _.formatHash(n)
            } : r && (a = {
                "If-None-Match": _.formatHash(r)
            });
            var c = "PUT";
            if (!i)
                return this.log("No activity profile was included."),
                !1;
            i instanceof Array ? (i = JSON.stringify(i),
            (a = a || {})["Content-Type"] = "application/json") : i instanceof Object ? (i = JSON.stringify(i),
            (a = a || {})["Content-Type"] = "application/json",
            c = "POST") : (a = a || {})["Content-Type"] = "application/octet-stream",
            _.XHR_request(this.lrs, s, c, i, this.lrs.auth, o, null, !1, a, this.withCredentials, this.strictCallbacks)
        }
    }
    ,
    ...
    t.prototype.deleteActivityProfile = function(t, e, i, n, r) {
        if (this.testConfig()) {
            ...
            var s = null;
            i && n ? u("Can't have both If-Match and If-None-Match") : i ? s = {
                "If-Match": _.formatHash(i)
            } : n && (s = {
                "If-None-Match": _.formatHash(n)
            });
    ...
    t.prototype.sendAgentProfile = function(t, e, i, n, r, o) {
        if (this.testConfig()) {
            ...
            var c = "PUT";
            if (!i)
                return this.log("No agent profile was included."),
                !1;
            i instanceof Array ? (i = JSON.stringify(i),
            (a = a || {})["Content-Type"] = "application/json") : i instanceof Object ? (i = JSON.stringify(i),
            (a = a || {})["Content-Type"] = "application/json",
    ...
    t.prototype.getAgentProfile = function(t, e, i, n) {
        if (this.testConfig()) {
            ...
            r = (r = r.replace("<agent>", encodeURIComponent(JSON.stringify(t)))).replace("<profileid>", encodeURIComponent(e)),
            e && (r += "&profileId=" + encodeURIComponent(e)),
            i && null != (i = isDate(i)) && (r += "&since=" + encodeURIComponent(i.toISOString()));
            var o = _.XHR_request(this.lrs, r, "GET", null, this.lrs.auth, n, null, !0, null, this.withCredentials, this.strictCallbacks);
            if (void 0 === o || 404 == o.status)
    ...
    _.dateFromISOString = function(t) {
        ...
        e[14] && (i = 60 * Number(e[16]) + Number(e[17]),
        i *= "-" == e[15] ? 1 : -1),
        i -= n.getTimezoneOffset(),
        time = Number(n) + 60 * i * 1e3;
        var r = new Date;
        return r.setTime(Number(time)),
        r
    }
    ,
    _.XHR_request = function(t, n, r, e, i, o, s, a, c, p, l) {
        "use strict";
        var u, d, h, f, g, v, y = !1, m = !1, S = !1, b = n.toLowerCase().match(/^(.+):\/\/([^:\/]*):?(\d+)?(\/.*)?$/), w = window.location, x = {
            "Content-Type": "application/json"
        };
        if (x.Authorization = i,
        x["X-Experience-API-Version"] = _.XAPIWrapper.xapiVersion,
        null !== c)
            for (var C in c)
                c.hasOwnProperty(C) && (x[C] = c[C]);
        if (m = (m = w.protocol.toLowerCase() !== b[1] || w.hostname.toLowerCase() !== b[2]) || (null === b[3] ? "http" === b[1] ? "80" : "443" : b[3]) === w.port,
        null !== t && void 0 !== t.extended) {
            for (g in f = new Array,
            t.extended)
        ...
        if (m && void 0 !== R && !1 !== R)
            ...
            d = function(t, e, i, n) {
                var r = e
                  , o = new Array
                  , s = r.indexOf("?");
                if (0 < s && (o.push(r.substr(s + 1)),
                r = r.substr(0, s)),
                r = r + "?method=" + t,
                null !== i)
                    for (var a in i)
                        i.hasOwnProperty(a) && o.push(a + "=" + encodeURIComponent(i[a]));
        ...
        !o) {
            if (S)
                for (v = 1e3 + new Date; new Date < v && 4 !== u.readyState && !y; )
                    A = void 0,
    ...
    _.xhrRequestOnError = function(e, t, i, n, r, o) {
        if (n && o) {
            ...
            if (s = a ? new Error("Request error: " + e.status) : 0 === a || null === a ? new Error("Request error: aborted") : new Error("Reqeust error: unknown"),
            r)
                n(s, e, r);
            else {
                var c;
...
function(s) {
    function r(t, e) {
        var i = e.split(".")
          , n = i[0];
        return e = i.slice(1).join("."),
        t[n] || (/\[\]$/.test(n) ? (n = n.slice(0, -2),
    ...
    function n(t, e, i, n) {
        ...
        t ? t instanceof a ? this.actor = t : "Agent" !== t.objectType && t.objectType ? "Group" === t.objectType && (this.actor = new c(t)) : this.actor = new a(t) : this.actor = null,
        this.verb = e ? e instanceof p ? e : new p(e) : null,
        i ? "Activity" !== i.objectType && i.objectType ? "Agent" === i.objectType ? this.object = i instanceof a ? i : new a(i) : "Group" === i.objectType ? this.object = i instanceof c ? i : new c(i) : "StatementRef" === i.objectType ? this.object = i instanceof u ? i : new u(i) : "SubStatement" === i.objectType ? this.object = i instanceof d ? i : new d(i) : this.object = null : this.object = i instanceof l ? i : new l(i) : this.object = null,
        n && (this.result = n),
    ...
    var a = function(t, e) {
        ...
        t && (t.mbox || t.mbox_sha1sum || t.openid || t.account))
            ...
            /^mailto:/.test(t) ? this.mbox = t : /^[0-9a-f]{40}$/i.test(t) ? this.mbox_sha1sum = t : /^http[s]?:/.test(t) ? this.openid = t : t && t.homePage && t.name && (this.account = t)
    };
    ...
    var p = function(t, e) {
        if (t && t.id)
            ...
            this.id = t,
            e && ("string" == typeof e || e instanceof String ? this.display = {
                "en-US": e
            } : this.display = e)
    };
    ...
    var l = function(t, e, i) {
        if (t && t.id) {
            ...
            this.id = t,
            (e || i) && (this.definition = {},
            "string" == typeof e || e instanceof String ? this.definition.name = {
                "en-US": e
            } : e && (this.definition.name = e),
            "string" == typeof i || i instanceof String ? this.definition.description = {
                "en-US": i
...
function(t) {
    var a = t
      , e = !1;
    "undefined" != typeof window && (a = window.ADL = t.ADL || {},
    e = !0);
    function n(t) {
        if ("SubStatement" === t.objectType && "SubStatement" !== t.object.objectType && !(t.id || t.stored || t.version || t.authority))
            return a.xapiutil.getActorId(t.actor) + ":" + a.xapiutil.getVerbDisplay(t.verb) + ":" + a.xapiutil.getObjectId(t.object)
    }
    a.xapiutil = {},
    a.xapiutil.getLang = function() {
        ...
        else if ("undefined" != typeof process && void 0 !== process.env && void 0 !== process.env.LANG) {
    ...
    a.xapiutil.getLangVal = function(t) {
        if (t && 0 != Object.keys(t).length) {
            for (var e, i = a.xapiutil.getLang(), n = !1; t[i] ? (e = t[i],
            n = !0) : i.indexOf("-") && (i = i.substring(0, i.lastIndexOf("-"))),
            !n && "" !== i; )
                ;
            return e
        }
    ...
    a.xapiutil.getMoreStatements = function(n, r, o) {
        ...
        a.XAPIWrapper.getStatements(o, null, function t(e) {
            if (e && e.response) {
                ...
                i.statements && (s = s.concat(i.statements),
                n-- <= 0 ? r(s) : i.more && "" !== i.more ? a.XAPIWrapper.getStatements(o, i.more, t) : "" === i.more && r(s))
            }
        })
    }
    ,
    ...
    a.xapiutil.getVerbDisplay = function(t) {
        if (t)
            return t.display && a.xapiutil.getLangVal(t.display) || t.id
    }
    ,
...
function() {
    ...
    function d(t) {
        var e = "xAPILaunchKey=" + u("xAPILaunchKey") + "&xAPILaunchService=" + u("xAPILaunchService");
        u("encrypted") && (e += "&encrypted=true");
        for (var i = 0; i < t.length; i++) {
            var n = t[i]
              , r = n.href
              , o = n.attributes.getNamedItem("courselink");
            o && "true" == o.value && (r = -1 < r.indexOf("?") ? r + "&" + e : r + "?" + e,
            n.href = r)
        }
    }
    l.launch = function o(s, a, c) {
        ...
        try {
            ...
            p.onload = function(t) {
                if (200 !== p.status)
                    return p.onerror(p.responseText);
                    ...
                    new MutationObserver(function(t) {
                        t.forEach(function(t) {
                            for (var e in t.addedNodes)
                                t.addedNodes.hasOwnProperty(e) && t.addedNodes[e].constructor == HTMLAnchorElement && d([t.addedNodes[e]])
                        })
                    }
                    ).observe(t, {
                        attributes: !0,
